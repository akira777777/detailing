...
const BookingConfirmation = () => {
  const { carModel, totalPrice, modules, bookingDate, bookingTime } = useBookingStore();
    ...
    <div className="pt-32 pb-24 px-4 lg:px-12 bg-background-light dark:bg-background-dark min-h-screen flex flex-col items-center">
      <div className="max-w-[800px] w-full flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-gray-900 dark:text-white tracking-tight text-4xl md:text-5xl font-extrabold leading-tight pb-3">Booking Confirmed!</h1>
            <p className="text-gray-600 dark:text-white/60 text-base md:text-lg font-normal leading-normal max-w-md">Your vehicle is in good hands. We've sent a detailed confirmation to your email address.</p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="bg-gray-100 dark:bg-background-dark/50 p-4 rounded-lg border border-gray-200 dark:border-white/5">
                            <p className="text-gray-900 dark:text-white text-lg font-bold">{fullDateFormatter.format(displayDate)}</p>
                            <p className="text-gray-600 dark:text-white/60">{bookingTime || 'Selected Time'} Appointment</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4">
                        <h3 className="text-gray-900 dark:text-white text-sm font-bold uppercase tracking-wider flex items-center gap-2">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
             <div className="bg-white dark:bg-panel-dark p-6 rounded-xl border border-gray-200 dark:border-white/5 flex gap-4 shadow-sm dark:shadow-none">
                <div className="flex-1">
                    <h3 className="text-gray-900 dark:text-white font-bold mb-2">Salon Location</h3>
                    <p className="text-gray-600 dark:text-white/60 text-sm mb-4">742 Detailing Blvd, <br/>Performance District, CA 90210</p>
             ...
             <div className="bg-white dark:bg-panel-dark p-6 rounded-xl border border-gray-200 dark:border-white/5 flex flex-col justify-between shadow-sm dark:shadow-none">
                <div>
                    <h3 className="text-gray-900 dark:text-white font-bold mb-2">Need Help?</h3>
                    <p className="text-gray-600 dark:text-white/60 text-sm">If you need to reschedule or have special instructions, contact our concierge.</p>
                </div>
                <div className="flex gap-4 mt-4">
                    <a href="tel:5551234567" className="flex-1 h-10 flex items-center justify-center gap-2 rounded-lg bg-gray-100 dark:bg-background-dark/50 text-gray-900 dark:text-white border border-gray-200 dark:border-white/5 text-sm font-bold hover:bg-gray-200 dark:hover:bg-white/5">
                        <span className="material-symbols-outlined text-[18px]">call</span>
                        Call Us
                    </a>
                     <a href="mailto:support@prodetail.com" className="flex-1 h-10 flex items-center justify-center gap-2 rounded-lg bg-gray-100 dark:bg-background-dark/50 text-gray-900 dark:text-white border border-gray-200 dark:border-white/5 text-sm font-bold hover:bg-gray-200 dark:hover:bg-white/5">
        ...
        <div className="mt-8 pb-12 text-center">
            <p className="text-gray-400 dark:text-white/30 text-xs">Confirmation ID: PRD-90124-B1 <br/>© 2024 Luxe Detail Salon Professional Services</p>
        </div>
      </div>
    </div>
  );
